...
<div id="wrapper" class="hfeed">
    <div id="header">
				<div id="name"><h1 class="site-title"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><?php bloginfo( 'name' ); ?></a></h1></div><div id="login"> <a href="/wp-admin/"> Login </a></div>
				<div style="margin: 0; height: 30px;"><?php wp_nav_menu( array('menu' => 'Main' )); ?></div>
